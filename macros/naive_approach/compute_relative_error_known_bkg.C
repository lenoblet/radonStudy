void compute_relative_error_known_bkg()  {
...
///////////////////////////////////////////////////////////////////////////////
	...
	for (i=0;i<n;i++)  {
		...
		//rolke_bulk->SetKnownBkgBinomEff(y_bulk[i],289,300000,0);                    /// 289   evts selected on 300 000 evts generated 0 bkg
		//rolke_surface->SetKnownBkgBinomEff(y_surface[i],665,300000,0);              /// 665   evts selected on 300 000 evts generated 0 bkg
		rolke_tracker->SetKnownBkgBinomEff(y_tracker[i],20162,300000,y_tot_bkg[i]);   /// 31791 evts selected on 300 000 evts generated (foil) bkg
...
///////////////////////////////////////////////////////////////////////////////
	...
	gr_center_tracker->GetXaxis()->SetTitle("Time of exposure [days]");
	gr_center_tracker->GetYaxis()->SetTitle("Number of expected events");
	gr_center_tracker->GetXaxis()->SetLabelSize(0.05);
	gr_center_tracker->GetYaxis()->SetLabelSize(0.05);
	gr_center_tracker->GetXaxis()->SetTitleSize(0.05);
	gr_center_tracker->GetYaxis()->SetTitleSize(0.05);
	gr_center_tracker->GetYaxis()->SetTitleOffset(1.3);
